    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-red-600 selection:text-white scroll-smooth">
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10px] text-sky-400 uppercase font-bold tracking-widest">
                Premium
              </span>
            </div>
          </div>
      ...
      <section className="relative py-32 px-6 flex flex-col items-center text-center overflow-hidden border-b border-zinc-900">
        ...
        <p className="max-w-2xl text-zinc-400 text-lg md:text-xl font-light leading-relaxed mb-10">
          La verdadera carne argentina, directo a tu mesa. Sin especulaciones,
          con el valor de la familia.
        </p>
        <div className="flex flex-wrap justify-center gap-4">
          <a
            href="#productos"
            className="bg-red-600 hover:bg-red-700 text-white font-black px-8 py-3 rounded-full text-sm uppercase transition-colors"
          >
            Ver Cortes
          </a>
          <a
            href="#historia"
            className="bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-white font-bold px-8 py-3 rounded-full text-sm uppercase transition-colors"
          >
            Conocenos
          </a>
        </div>
      ...
      <section
        id="historia"
        className="py-24 bg-zinc-950 px-6 border-b border-zinc-900"
      >
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div className="inline-block border-l-4 border-sky-400 pl-4">
              <h3 className="text-sm font-bold text-sky-400 uppercase tracking-widest mb-1">
                Nuestra Esencia
              </h3>
              <h4 className="text-3xl font-black uppercase tracking-tighter">
                El puente hacia{" "}
                <span className="text-red-600">el buen fuego</span>
              </h4>
            </div>
            ...
            <div className="space-y-6 text-zinc-400 font-light leading-relaxed">
              <p>
                ...
                es un emprendimiento familiar que nació con un propósito claro:
                facilitar a todos el acceso directo a productos de calidad a
                precios reales.{" "}
              ...
              <p>
                Buscamos generar una red de reciprocidad. Nuestro objetivo es
                ser el puente entre la calidad y el disfrute. Un puente para
                llegar con lo mejor a ese asado de amigos, ser un puente para
                que las pibas le metan a ese fuego.
              </p>
              <blockquote className="border-l-2 border-red-600 pl-6 py-2 my-8 text-white italic text-lg bg-zinc-900/50 rounded-r-lg">
                "Que nuestros hijos disfruten los platos que nuestros padres y
                abuelos nos regalaban, con esos sabores, con el mismo amor."
              </blockquote>
              <p>
                Respetando el esfuerzo ajeno, entendiendo que todo cuesta y que
                cada momento vale. Sabiendo que merecemos lo mejor, porque
                producimos lo mejor.
              </p>
            </div>
          </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-black/60 backdrop-blur-md p-4 rounded-xl border border-zinc-700">
                  <h5 className="text-sky-400 font-black text-sm uppercase mb-1">
                    Envío
                  </h5>
                  <p className="text-xs text-zinc-300">
                    Sin cargo, horario pactado
                  </p>
                </div>
                <div className="bg-black/60 backdrop-blur-md p-4 rounded-xl border border-zinc-700">
                  <h5 className="text-sky-400 font-black text-sm uppercase mb-1">
      ...
      <section id="productos" className="max-w-7xl mx-auto py-24 px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6 border-b border-zinc-800 pb-8">
          ...
          <p className="text-zinc-500 max-w-sm text-right text-sm">
            Elegí tus cortes, armá tu carrito, y envianos un WhatsApp directo
      ...
      <section
        id="mayoristas"
        className="relative py-24 border-t border-zinc-900 overflow-hidden bg-zinc-950"
      >
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-zinc-400 text-lg font-light leading-relaxed mb-8">
              ...
              <strong className="text-white">
                carnicerías, restaurantes, parrillas y servicios de catering
              </strong>{" "}
              con mercadería de calidad innegociable. Garantizamos continuidad,
              volumen y el respeto por el producto que tu negocio necesita para
              destacarse.
            </p>
      ...
      <footer
        id="contacto"
        className="bg-black border-t border-zinc-900 py-20 px-6 text-center"
      >
        <p className="text-zinc-500 uppercase tracking-widest text-xs mb-6">
          ¿Contamos con vos?
        </p>
        ...
        <p className="text-zinc-500 text-sm uppercase tracking-widest font-bold">
          Raíces Tech © {new Date().getFullYear()}
        </p>
      </footer>
    </div>
  );
